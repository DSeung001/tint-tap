...
#### 도트 캐릭터 애니메이션
- 기믹 종류에 따라 다른 장난 애니메이션
- 예: 타일을 뒤섞을 때 캐릭터가 웃으면서 손을 흔드는 애니메이션
- 예: 타일을 숨길 때 캐릭터가 장난스럽게 손가락을 흔드는 애니메이션
...
#### 도트 캐릭터 애니메이션
- 타일을 뒤섞을 때 캐릭터가 웃으면서 손을 흔드는 애니메이션
- 뒤섞기 완료 후 장난스러운 표정
...
#### 동작 방식
- `config.gimmicks.gimmicks[].count` (기본값: [1, 5]) 범위 내에서 무작위로 타일 숨김
...
#### 도트 캐릭터 애니메이션
- 타일을 숨길 때 캐릭터가 장난스럽게 손가락을 흔드는 애니메이션
- 숨긴 후 교활한 웃음 표정
...
#### 도트 캐릭터 애니메이션
- 타일이 깜빡일 때 캐릭터가 눈을 깜빡이는 애니메이션
- 페이드 효과 시 손을 흔들며 장난치는 모션
...
#### 도트 캐릭터 애니메이션
- 블러 효과 시 캐릭터가 안경을 쓰는 동작
- 그림자 효과 시 손으로 그림자를 만드는 모션
